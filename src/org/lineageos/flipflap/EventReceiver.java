...
public class EventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (com.libremobileos.content.Intent.ACTION_LID_STATE_CHANGED.equals(intent.getAction())) {
            PowerManager powerManager = context.getSystemService(PowerManager.class);
            BatteryManager batMan = context.getSystemService(BatteryManager.class);
            int lidState = intent.getIntExtra(com.libremobileos.content.Intent.EXTRA_LID_STATE, -1);
